...
const Request4 = () => {
  ...
  return (
    <View style={styles.request}>
      ...
      <Pressable
        style={[styles.requestChild, styles.childLayout]}
      ...
      <View style={styles.elderlyStatusParent}>
        ...
        <View style={styles.textField1}>
          <View style={[styles.textField1Child, styles.childBorder]} />
          <View style={[styles.textField13Inner, styles.notePosition]}>
        ...
        <View style={styles.textField1}>
          ...
          <View style={[styles.textField13Inner, styles.notePosition]}>
            <View style={[styles.frameView, styles.frameViewFlexBox]}>
              <Text style={styles.textTypo}>Nation</Text>
              <Image
                style={styles.mdirequiredIcon}
                resizeMode="cover"
                source={require("../assets/mdirequired.png")}
        ...
        <View style={styles.textField1}>
          ...
          <View style={[styles.textField13Inner, styles.notePosition]}>
            <View style={[styles.frameView, styles.frameViewFlexBox]}>
              <Text style={styles.textTypo}>Province/ City</Text>
              <Image
                style={styles.mdirequiredIcon}
                resizeMode="cover"
                source={require("../assets/mdirequired.png")}
        ...
        <View style={styles.textField1}>
          ...
          <View style={[styles.textField13Inner, styles.notePosition]}>
            <View style={[styles.frameView, styles.frameViewFlexBox]}>
              <Text style={styles.textTypo}>District/ Ward</Text>
              <Image
                style={styles.mdirequiredIcon}
                resizeMode="cover"
                source={require("../assets/mdirequired.png")}
        ...
        <View style={styles.textField1}>
          ...
          <View style={[styles.textField13Inner, styles.notePosition]}>
            <View style={[styles.frameView, styles.frameViewFlexBox]}>
              <Text style={styles.textTypo}>Street/ House Number</Text>
              <Image
                style={styles.mdirequiredIcon}
                resizeMode="cover"
                source={require("../assets/mdirequired.png")}
        ...
        <View style={[styles.groupWrapper, styles.groupLayout]}>
          <View style={[styles.rectangleGroup, styles.groupLayout]}>
            <View style={[styles.groupChild, styles.groupLayout]} />
            <Text style={[styles.note, styles.notePosition]}>
              Job Description
            </Text>
          </View>
        </View>
